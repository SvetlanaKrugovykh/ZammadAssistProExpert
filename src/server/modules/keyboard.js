const buttonsConfig = {
  ...
  standardStartButtons: {
    ...
    options: [{ resize_keyboard: true }],
    buttons: [
      [{ text: '➕ Створити нову заявку текстом або голосом', callback_data: '5_2' }],    //2_1
...
//      [{ text: '🏢 Додати картинку до заявки (1 клік = 1 картинка!)', callback_data: '5_5' }],
      [{ text: '🧷 Додати файл до заявки (1 клік = 1 файл!)', callback_data: '5_3' }],
  ...
  messageCreate: {
    ...
    buttons: [
      ...
      [{ text: '🧷 Додати файл до відправлення (1 клік = 1 файл!)', callback_data: '5_3' }],
